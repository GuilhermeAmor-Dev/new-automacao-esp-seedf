...
- Reformulação dos **wireframes** para atualização conforme os novos _flowcharts_.
...
- **Atualizar cronograma e Jira** com novas datas e critérios de aceite.
  ...
  - **Prazo:** antes da próxima _daily_
...
- **Aplicar o fluxo de Git** nas próximas alterações de documentação e exigir _Pull Request_ com revisão.
  - **Responsáveis:** todos
  - **Prazo:** contínuo
